...
from .views import LostChildList, FoundChildList, ReceivedChildCreate, ReportUpdateAPIView, LostMatchedReports, GetMatchedReports, ReceivedChildList, ReportsByUser, UpdateChildStatus, LostChildCreate, LostChildren, FoundChildren, image_view
...
#     path('', include(router.urls)),
     ...
     path('lost-children/', LostChildList.as_view(),
         name='lost_child_view'),
     path('found-children/', FoundChildList.as_view(),
         name='found_child_view'),
